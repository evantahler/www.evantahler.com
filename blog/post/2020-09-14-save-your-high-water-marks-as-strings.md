...
author: Evan Tahler
description: >-
  Asking the database to return the High Water Mark as a string prevents a
  number of bugs.
...
![Getting your API Key and Secret](/images/posts/2020-09-14-save-your-high-water-marks-as-strings/database.png)
