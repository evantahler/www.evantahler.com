...
author: Evan Tahler
description: >-
  We're building increasingly complex integrations to connect coding agents to
  MCP servers. But these agents already know how to use the CLI. So why are we
  teaching them a new interface?
...
![curl for MCP: Why Coding Agents Are Happier Using the CLI](/images/posts/2026-03-13-curl-for-mcp/image1.png)
