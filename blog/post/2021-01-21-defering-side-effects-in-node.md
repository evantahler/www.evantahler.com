...
author: Evan Tahler
description: >-
  Using AsyncHooks, you can collect side-effects within a database transaction
  and only run them if the transaction succeeds
...
![A glowing laptop](/images/posts/2021-01-21-defering-side-effects-in-node/laptop.jpeg)
