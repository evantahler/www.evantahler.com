...
author: Evan Tahler
description: >-
  How does Grouparoo use Next.js to load pages and components from plugins to
  modify our web user interface?
...
::: tip
To see the project described in this blog post, please visit the [github.com/grouparoo/next-plugins-example](https://github.com/grouparoo/next-plugins-example) repository.
:::
...
![A screenshot of the Github Repo](/images/posts/2020-07-23-nextjs-plugins/repo-screenshot.png)
...
![The plugin loads and shows a note](/images/posts/2020-07-23-nextjs-plugins/console-note.png)
