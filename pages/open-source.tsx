    ...
    <Page title={title}>
      <>
        ...
        <Alert variant="info">
          <p>
            <strong>
              You can now soponsor my work via Github Sponsorships!
            </strong>
          </p>
          <p>
        ...
        <p>
          I contribute to a number of Open Source projects because I belive it
          is a great way to give back to the programming community in both a
          professional and personal capacity... and a great way to learn about
