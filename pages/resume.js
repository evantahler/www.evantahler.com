  ...
  return (
    <Page title={title}>
      <>
        ...
        <p>
          Evan is looking for what's next! Most recently, he was the Chief Product Officer at <a target='_new' href='https://www.voom.flights'>Voom, an Airbus Company</a>, providing an urban air mobility to cities around the world.
        </p>

        <p>
          Evan has deep expertise in building the technical side of B2C products as well as the teams required to do so. He’s helped companies like <a target='_new' href='https://www.disney.com'>Disney</a>, <a target='_new' href='https://www.taskrabbit.com'>TaskRabbit</a>, <a target='_new' href='https://www.modcloth.com'>ModCloth</a>, and <a target='_new' href='https://www.airbus.com'>Airbus</a> launch new global digital initiatives. He is named on a number of patents focusing on mobile interactions and digital entertainment. Evan is an open-source innovator, and frequent speaker at software development conferences focusing on Product Managment, Node.JS, Rails, and databases.
        </p>
