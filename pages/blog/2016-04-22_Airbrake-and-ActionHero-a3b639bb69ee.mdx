...
\_ah-airbrake-plugin - actionhero plugin for airbrake_github.com](https://github.com/evantahler/ah-airbrake-plugin "https://github.com/evantahler/ah-airbrake-plugin")[](https://github.com/evantahler/ah-airbrake-plugin)
...
_// in initializers/airbrake.js_
...
api.airbrake **\=** {};
api.airbrake.token **\=** api.config.general.airbrake*token;
api.airbrake.client **\=** airbrakePrototype.createClient(api.airbrake.token);
api.airbrake.client.handleExceptions(); *// catch global uncaught errors\_
_// api.airbrake.client.developmentEnvironments = \[\]; // don't report in various NODE_ENVs_
...
_Originally published at 13 Feb 2014_
