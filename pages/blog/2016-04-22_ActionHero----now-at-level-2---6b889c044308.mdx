...
"redis" : { "enable": true, "host": "127.0.0.1", "port": 6379, "password": null, "options": null }, All methods under the api.actionCluster namespace have been removed for simplicity. Just use the normal cache methods, and if you are in a cluster, you will operate in a shared memory space.
...
_Originally published at 23 May 2012_
