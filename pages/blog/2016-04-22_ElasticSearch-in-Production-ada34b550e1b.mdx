...
_\# from elasticsearch.in.sh.erb_
**if** **\[** "x$ES\_USE\_GC\_LOGGING" !**\=** "x" **\]**; **then**
  JAVA\_OPTS**\=**"$JAVA_OPTS -XX:+PrintGCDetails"
JAVA_OPTS**\=**"$JAVA\_OPTS -XX:+PrintGCTimeStamps"
  JAVA\_OPTS**\=**"$JAVA_OPTS -XX:+PrintClassHistogram"
JAVA_OPTS**\=**"$JAVA\_OPTS -XX:+PrintTenuringDistribution"
  JAVA\_OPTS**\=**"$JAVA_OPTS -XX:+PrintGCApplicationStoppedTime"
...
...
_\# JAVA_OPTS="$JAVA_OPTS -XX:+UseParNewGC"_
_\# JAVA_OPTS="$JAVA_OPTS -XX:+UseConcMarkSweepGC"_

_\# JAVA_OPTS="$JAVA_OPTS -XX:CMSInitiatingOccupancyFraction=75"_
_\# JAVA_OPTS="$JAVA_OPTS -XX:+UseCMSInitiatingOccupancyOnly"_
...
_Originally published at 18 Jul 2014_
