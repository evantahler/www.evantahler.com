...
In [my previous post](https://blog.evantahler.com/productionizing-flynn-and-hosting-your-root-domain-s-fc849638e206#.e1f6yjk7i), I shared some tips on creating a production Flynn cluster. If you don’t know, [Flynn](https://flynn.io) is a an open-source self-hosted Heroku replacement (PASS).
...
- git pull
- git remote add flynn [https://user:$FLYNN_KEY@git.server.com/myapp.git](https://user:$FLYNN_KEY@git.messagebot.io/www.git) || true
- git push flynn master
