...
\_elasticsearch-dump - Import and export tools for elasticsearch_github.com](https://github.com/taskrabbit/elasticsearch-dump "https://github.com/taskrabbit/elasticsearch-dump")[](https://github.com/taskrabbit/elasticsearch-dump)

### Use

elasticdump works by sending an input to an output. Both can be either an elasticsearch URL or a File.

Elasticsearch: — format: {proticol}://{host}:{port}/{index} — example: [http://127.0.0.1:9200/my_index](http://127.0.0.1:9200/my_index)
...
elasticdump — input=http://production.es.com:9200/my\_index — output=http://staging.es.com:9200/my\_index

- Backup an index to a file:

elasticdump — input=http://production.es.com:9200/my\_index — output=/var/dat/es.json
