...
<ReactMarkdown source={this.props.markdown} escapeHtml={false} renderers={{}} />
) } }
...
- In the final version of the page’s source (which you can see here [https://github.com/actionhero/www.actionherojs.com/blob/master/pages/tutorials/%5Bname%5D.tsx](https://github.com/actionhero/www.actionherojs.com/blob/master/pages/tutorials/%5Bname%5D.tsx)) you can see that we do even more in the header’s render message, link changing colors if the section is in view, highlighting things, etc. It’s very powerful!
