...
name**:** "sayHello",
runAt**:** **new** Date().getTime() **+** 30000, _// run 30 seconds from now_
params**:** {name**:** 'Evan'}, _// any optional params to pass to the task_
...
data**:** 'actionHero:tasks:data', _// actually a hash_
workerStatus**:** 'actionHero:tasks:workerStatus', _// actually a hash_
