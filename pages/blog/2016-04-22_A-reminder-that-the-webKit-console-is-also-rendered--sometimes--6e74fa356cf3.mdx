...
function log_and_incrament(){
if(test_int &lt; 3){
test_int = test_int + 1;
test_arr.push(test_int);
test_obj\[("counter\_" + test_int)\] = test_int;

        console.log("\\r\\n value of test integer: ");
        console.log(test\_int);
        console.log("value of test array: ");
        console.log(test\_arr);
        console.log("value of test object: ");
        console.log(test\_obj);

        setTimeout("log\_and\_incrament", sleep);
    }
...
_Originally published at 03 Dec 2011_
