...
export CXX=$TOOL\_PREFIX-g++
export AR=$TOOL_PREFIX-ar
export RANLIB=$TOOL\_PREFIX-ranlib
...
cd node-v0.6.7
./configure --shared-v8 --shared-v8-libpath=/opt/share/v8 --shared-v8-includes=/opt/share/v8/include --without-snapshot ## If the configuration isn't all green, something is wrong
make
make install
...
_Originally published at 16 Jan 2012_
