...
1 ActiveRecord**::**ConnectionAdapters**::**AbstractAdapter**.**class_eval **do**
2 **attr_reader** :last_query
3 **def** **log_with_last_query**(sql, name, **&**block)
4 @last_query **\=** **\[**sql, name**\]**
5 Octopus**::**Proxy**.**master_lock?(sql)
6 log_without_last_query(sql, name, **&**block)
7 **end**
8 alias_method_chain :log, :last_query
9 **end**
...
1 production:
2 sticky_slave: **true**
3 sticky_master: **true**
4 adapter: makara
5 db_adapter: mysql2
6 host: xxx
7 user: xxx
8 password: xxx
9 blacklist_duration: 5
10 databases:
11 **\-** name: master
12 role: master
13 **\-** name: slave1
...
[**taskrabbit/makara**
\_makara - A Read-Write Proxy for Connections; Also provides an ActiveRecord adapter.\_github.com](https://github.com/taskrabbit/makara "https://github.com/taskrabbit/makara")[](https://github.com/taskrabbit/makara)

_Originally published at 29 Jan 2013_
